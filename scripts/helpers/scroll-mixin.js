 ...
 * sheet bodies, health panels, spell lists, charactermancer panels, etc.
 */
const SCROLL_SELECTORS = '.window-content, .sheet-body, .reign-scroll-y, .reign-spell-scroll, .reign-health-data-list, .cm-results-left, .cm-biography, .cm-editor, .cp-results-left, .cp-summary-right';
