 ...
 * PHASE 3: Injects Gobble Dice arrays for Defense Tracking.
 * PHASE 6: Injects pool breakdown math for transparent UI.
 */
...
// PHASE 6.5 FIX: Added `rollInstance` to the parameters so we can attach it to the ChatMessage
export async function postOREChat(actor, label, totalPool, results, expertDie, masterDiceCount, item = null, flags = {}, rollInstance = null) {
  ...
  // PHASE 6.5 FIX: If a roll instance was passed, attach it. This automatically triggers Dice So Nice!
  if (rollInstance) {
