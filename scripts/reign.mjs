  ...
  if (reignFlags?.isDefense
      ...
      if (!existingCoverBtn) {
          ...
          if (card) {
              ...
              coverBtnWrapper.style.cssText = "padding: 6px 10px 2px; text-align: center;";
              coverBtnWrapper.innerHTML = `<button class="dive-for-cover-btn" style="width:100%; cursor:pointer;" title="Sacrifice your Gobble Dice to dive behind an obstacle. You'll be downed but protected."><i class="fas fa-shield-alt"></i> Dive for Cover</button>`;
