...
Hooks.once("init", async () => {
  ...
  // AUDIT FIX P4: Updated to V13 flat array syntax for trackable attributes
  CONFIG.Actor.trackableAttributes = {
      character: {
          bar: ["health.torso.killing", "health.head.killing"],
          value: ["wealth.value", "xp.value"]
      },
      threat: {
          bar: ["magnitude.value", "morale.value"],
          value: ["threatLevel"]
      },
      company: {
          bar: ["qualities.might.current", "qualities.treasure.current", "qualities.influence.current", "qualities.territory.current", "qualities.sovereignty.current"],
          value: ["qualities.might.permanent", "qualities.treasure.permanent"]
      }
  };
