...
export async function consumeGobbleDie(attackMsg, targetSetHeight) {
    ...
    // Recalculate attacker initiative based on remaining sets using shared calculator
    if (game.combat) {
