...
export async function performPostCombatRecovery(actor) {
    ...
    if (totalRecovered > 0) {
        ...
        await ChatMessage.create({
            ...
            content: `<div class="reign-chat-card"><h3 style="color: #2d5a27;">Post-Combat Recovery</h3><p>Catching their breath, ${safeName} recovers <strong>${totalRecovered} Shock</strong> damage sustained during the battle (${modeLabel} recovery).</p></div>`
        });
    } else {
